...
public class SlowSword extends ItemSword implements IHasModel
{
	
	public SlowSword(String name, ToolMaterial material)
	{
		super(material);
	...
	public Multimap<String, AttributeModifier> getAttributeModifiers(final EntityEquipmentSlot slot, final ItemStack stack) {
		...
		if (slot == EntityEquipmentSlot.MAINHAND) {
			replaceModifier(modifiers, SharedMonsterAttributes.ATTACK_SPEED, ATTACK_SPEED_MODIFIER, 1.3);
		}
